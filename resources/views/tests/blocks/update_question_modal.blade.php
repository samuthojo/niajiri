{{-- start question update modal --}}
<div class="modal fade" id="question-update-modal-{{$question->id}}" tabindex="-1" role="dialog" aria-labelledby="questionUpdateModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h3 class="modal-title" id="questionUpdateModalLabel">
          <strong>
            {{trans('questions.actions.edit.label')}}
          </strong>
        </h3>
      </div>

      {{--start question update form--}}
      {!!
            Form::model($question, [
            'method' => 'PATCH',
            'route' => ['questions.update', $question->id],
            'id' => 'question_edit_form',
            'files' => true
        ])
      !!}
      @if($position)
