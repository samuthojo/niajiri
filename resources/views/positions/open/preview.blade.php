            ...
            <div class="ibox-content">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="m-t-md">
                             <a class="btn btn-primary pull-right" href="{{route('applications.create', ['position_id' => $position->id, 'organization_id' => $position->organization_id])}}" title="{{trans('positions.actions.apply.title')}}"></i>{{trans('positions.actions.apply.name')}}</a>
