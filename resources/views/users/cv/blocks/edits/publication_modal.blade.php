...
<div class="modal fade" id="user-edit-publications-modal-{{$publication->id}}" tabindex="-1" role="dialog" aria-labelledby="userPublicationsModalLabel-{{$publication->id}}" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h3 class="modal-title" id="userPublicationsModalLabel-{{$publication->id}}">
          <strong>
